...
REM
REM Generated by Vivado on Thu May 14 20:12:15 +0700 2026
...
echo "xvlog --incr --relax -prj address_mux_tb_vlog.prj"
call xvlog  --incr --relax -prj address_mux_tb_vlog.prj -log xvlog.log
